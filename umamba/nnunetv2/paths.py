...
│   ├── ...
"""
nnUNet_raw = os.environ['nnUNet_raw'] # os.environ.get('nnUNet_raw')
nnUNet_preprocessed = os.environ['nnUNet_preprocessed'] # os.environ.get('nnUNet_preprocessed')
nnUNet_results = os.environ['nnUNet_results'] # os.environ.get('nnUNet_results')
